...
def RequestSource():
    ...
    search='@worldrugby'  #page userName
    #page = '1'  courser for pagination
    iso='1'
    channel = 'worldrugby'  #channel name
    js = 'ture'
...
#https://giphy.com/search/@worldrugby?channel=worldrugby&is=1&json=true
...
def reqs(view_full_url, headers):
    ...
    print(d_data)
    file_varible = ('/home/nanoyotta/PycharmProjects/untitled/giphy4.csv')
    file_Empty = os.path.isfile( file_varible )
    with open( 'giphy4.csv', 'a' ) as file:
